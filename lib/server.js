...
var PUBLIC_MODULES_PATH = __dirname + '/node_modules';
...
var TEMPLATE_PATH = PUBLIC_MODULES_PATH + '/es_client/templates/';
...
exports.createServer = function(config){
  ...
  ***********************************************/
  ...
  // Server Static file servers
  app.use(express.static(PUBLIC_MODULES_PATH+'/es_prototype_client'));
  app.use('/es_client',express.static(PUBLIC_MODULES_PATH+'/es_client'));
  app.use('/test/',express.static(PUBLIC_MODULES_PATH+'/es_client/test'));
  ...
  **********************************************/
  ...
  app.get('/es_client/templates', function(req,res){
